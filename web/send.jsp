                                ...
                                <div class="span12">
                                    <div class="padded">
                                        ...
                                        <script>
                                            ...
                                            $("body").on("mouseover focus", "submit, button[type='submit']", function (e) {
                                                console.log($("#dispatchTitle").val());
                                                console.log($("#city").val());
                                                console.log($("#dispatchDetail").val());
                                                console.log($("#msgtags").val());
                                                $("#message").val(
                                                        $("#dispatchTitle").val() + " (" +
                                                                $("#city").val() + ")\n" +
                                                                $("#dispatchDetail").val()+
                                                                ( (!!$("#msgtags").val()) ? (" [tags: " + $("#msgtags").val()+"]") : ""));
                                            })
                                        </script>
                                        ...
                                        <div class="input">
                                            <textarea id="msgtags" class="tagme" placeholder="This is a textarea"></textarea>
                                        </div>
                                    </div>
                                </div>

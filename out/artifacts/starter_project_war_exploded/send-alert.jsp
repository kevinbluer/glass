...
<section id="timeline">
  ...
  <div class="do">
    ...
    <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
      ...
      <input type="hidden" name="iconUrl" value="<%= appBaseUrl + "static/icons/noun_project_910.png" %>" />
      <input type="hidden" name="contentType" value="image/png">
      <textarea name="message" placeholder="Alert! Something is happening somewhere!"></textarea><br/>
...
-->
  ...
  <br style="clear:all" />
<img src="./static/icons/noun_project_10354.png" style="background-color: red;" />
  <table class="see">
    <thead>
    <tr>
      <th>ID</th>
